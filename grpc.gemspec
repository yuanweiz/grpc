...
Gem::Specification.new do |s|
  ...
  s.files += %w( third_party/upb/upb/wire/decode_fast/cardinality.h )
  s.files += %w( third_party/upb/upb/wire/decode_fast/combinations.h )
  s.files += %w( third_party/upb/upb/wire/decode_fast/data.h )
  s.files += %w( third_party/upb/upb/wire/decode_fast/dispatch.c )
  s.files += %w( third_party/upb/upb/wire/decode_fast/dispatch.h )
  s.files += %w( third_party/upb/upb/wire/decode_fast/field_fixed.c )
  s.files += %w( third_party/upb/upb/wire/decode_fast/field_generic.c )
  s.files += %w( third_party/upb/upb/wire/decode_fast/field_message.c )
  s.files += %w( third_party/upb/upb/wire/decode_fast/field_parsers.h )
  s.files += %w( third_party/upb/upb/wire/decode_fast/field_string.c )
  s.files += %w( third_party/upb/upb/wire/decode_fast/field_varint.c )
  s.files += %w( third_party/upb/upb/wire/decode_fast/function_array.c )
  s.files += %w( third_party/upb/upb/wire/decode_fast/function_array.h )
