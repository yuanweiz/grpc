...
static const upb_MiniTable *messages_layout_envoy_extensions_load_balancing_policies_wrr_locality_v3_wrr_locality_proto_upb_file_layout[1] = {
...
const upb_MiniTableFile envoy_extensions_load_balancing_policies_wrr_locality_v3_wrr_locality_proto_upb_file_layout = {
  messages_layout_envoy_extensions_load_balancing_policies_wrr_locality_v3_wrr_locality_proto_upb_file_layout,
  NULL,
  NULL,
  1,
  0,
