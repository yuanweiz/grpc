...
static const upb_MiniTable *messages_layout_envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upb_file_layout[1] = {
...
const upb_MiniTableFile envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upb_file_layout = {
  messages_layout_envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upb_file_layout,
  NULL,
  NULL,
  1,
  0,
