...
} envoy__config__core__v3__Pipe_msg_init_Fields;

static const envoy__config__core__v3__Pipe_msg_init_Fields envoy_config_core_v3_Pipe__fields = {{
...
const upb_MiniTable envoy__config__core__v3__Pipe_msg_init = {
  &envoy_config_core_v3_Pipe__fields.fields[0],
...
typedef struct {
  upb_MiniTableField fields[2];
} envoy__config__core__v3__EnvoyInternalAddress_msg_init_Fields;

static const envoy__config__core__v3__EnvoyInternalAddress_msg_init_Fields envoy_config_core_v3_EnvoyInternalAddress__fields = {{
...
const upb_MiniTable envoy__config__core__v3__EnvoyInternalAddress_msg_init = {
  &envoy_config_core_v3_EnvoyInternalAddress__fields.fields[0],
...
} envoy__config__core__v3__SocketAddress_msg_init_Fields;

static const envoy__config__core__v3__SocketAddress_msg_init_Fields envoy_config_core_v3_SocketAddress__fields = {{
...
const upb_MiniTable envoy__config__core__v3__SocketAddress_msg_init = {
  &envoy_config_core_v3_SocketAddress__fields.fields[0],
  ...
  UPB_FASTTABLE_INIT({
    ...
    {0x0048001004000022, &upb_DecodeFast_String_Oneof_Tag1Byte},
    {0x002800003f00002a, &upb_DecodeFast_String_Scalar_Tag1Byte},
    {0x000800003f000030, &upb_DecodeFast_Bool_Scalar_Tag1Byte},
    {0x003800003f00003a, &upb_DecodeFast_String_Scalar_Tag1Byte},
  })
};
...
} envoy__config__core__v3__TcpKeepalive_msg_init_Fields;

static const envoy__config__core__v3__TcpKeepalive_msg_init_Fields envoy_config_core_v3_TcpKeepalive__fields = {{
...
} envoy__config__core__v3__ExtraSourceAddress_msg_init_Fields;

static const envoy__config__core__v3__ExtraSourceAddress_msg_init_Fields envoy_config_core_v3_ExtraSourceAddress__fields = {{
...
} envoy__config__core__v3__BindConfig_msg_init_Fields;

static const envoy__config__core__v3__BindConfig_msg_init_Fields envoy_config_core_v3_BindConfig__fields = {{
  ...
  {3, UPB_SIZE(20, 32), 0, UPB_SIZE(14, 16), 11, (int)kUpb_FieldMode_Array | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  ...
  {5, UPB_SIZE(28, 48), 0, UPB_SIZE(10, 14), 11, (int)kUpb_FieldMode_Array | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {6, UPB_SIZE(32, 56), 66, UPB_SIZE(8, 13), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
 },
  {
  {.UPB_PRIVATE(submsg) = &envoy__config__core__v3__SocketAddress_msg_init},
...
typedef struct {
  upb_MiniTableField fields[3];
  upb_MiniTableSubInternal subs[3];
} envoy__config__core__v3__Address_msg_init_Fields;

static const envoy__config__core__v3__Address_msg_init_Fields envoy_config_core_v3_Address__fields = {{
...
} envoy__config__core__v3__CidrRange_msg_init_Fields;

static const envoy__config__core__v3__CidrRange_msg_init_Fields envoy_config_core_v3_CidrRange__fields = {{
