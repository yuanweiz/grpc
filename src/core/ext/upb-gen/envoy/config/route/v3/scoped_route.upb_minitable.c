...
const upb_MiniTable envoy__config__route__v3__ScopedRouteConfiguration_msg_init = {
  ...
  UPB_FASTTABLE_INIT({
    ...
    {0x003800000109002a, &upb_DecodeFast_Message_Scalar_Tag1Byte},
    {0x0000000000000000, &_upb_FastDecoder_DecodeUnknown},
    {0x0000000000000000, &_upb_FastDecoder_DecodeUnknown},
  })
};
...
static const upb_MiniTable *messages_layout_envoy_config_route_v3_scoped_route_proto_upb_file_layout[3] = {
...
const upb_MiniTableFile envoy_config_route_v3_scoped_route_proto_upb_file_layout = {
  messages_layout_envoy_config_route_v3_scoped_route_proto_upb_file_layout,
  NULL,
  NULL,
  3,
  0,
