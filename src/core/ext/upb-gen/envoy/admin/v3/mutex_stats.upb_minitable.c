...
static const upb_MiniTable *messages_layout_envoy_admin_v3_mutex_stats_proto_upb_file_layout[1] = {
  &envoy__admin__v3__MutexStats_msg_init,
};

const upb_MiniTableFile envoy_admin_v3_mutex_stats_proto_upb_file_layout = {
  messages_layout_envoy_admin_v3_mutex_stats_proto_upb_file_layout,
  NULL,
  NULL,
  1,
  0,
