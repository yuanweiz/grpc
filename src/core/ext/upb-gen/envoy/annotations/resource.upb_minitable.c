...
const upb_MiniTableExtension* envoy_annotations_resource_ext = &envoy_annotations_resource_ext_obj;
  static const upb_MiniTable *messages_layout_envoy_annotations_resource_proto_upb_file_layout[1] = {
  &envoy__annotations__ResourceAnnotation_msg_init,
};


static const upb_MiniTableExtension *extensions_layout_envoy_annotations_resource_proto_upb_file_layout[1] = {
...
const upb_MiniTableFile envoy_annotations_resource_proto_upb_file_layout = {
  messages_layout_envoy_annotations_resource_proto_upb_file_layout,
  NULL,
  extensions_layout_envoy_annotations_resource_proto_upb_file_layout,
  1,
  0,
  1,
};
