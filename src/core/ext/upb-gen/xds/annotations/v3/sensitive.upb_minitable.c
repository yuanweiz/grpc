...
static const upb_MiniTableExtension *extensions_layout_xds_annotations_v3_sensitive_proto_upb_file_layout[1] = {
...
const upb_MiniTableFile xds_annotations_v3_sensitive_proto_upb_file_layout = {
  NULL,
  NULL,
  extensions_layout_xds_annotations_v3_sensitive_proto_upb_file_layout,
  0,
  0,
  1,
};
