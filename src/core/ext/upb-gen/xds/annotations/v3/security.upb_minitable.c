...
static const upb_MiniTableExtension xds_annotations_v3_security_ext_obj = {
...
const upb_MiniTableExtension* xds_annotations_v3_security_ext = &xds_annotations_v3_security_ext_obj;
  static const upb_MiniTable *messages_layout_xds_annotations_v3_security_proto_upb_file_layout[1] = {
  &xds__annotations__v3__FieldSecurityAnnotation_msg_init,
};


static const upb_MiniTableExtension *extensions_layout_xds_annotations_v3_security_proto_upb_file_layout[1] = {
  &xds_annotations_v3_security_ext_obj,
};
...
const upb_MiniTableFile xds_annotations_v3_security_proto_upb_file_layout = {
  messages_layout_xds_annotations_v3_security_proto_upb_file_layout,
  NULL,
  extensions_layout_xds_annotations_v3_security_proto_upb_file_layout,
  1,
  0,
  1,
};
