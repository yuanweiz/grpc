...
static const upb_MiniTable *messages_layout_xds_core_v3_context_params_proto_upb_file_layout[2] = {
...
const upb_MiniTableFile xds_core_v3_context_params_proto_upb_file_layout = {
  messages_layout_xds_core_v3_context_params_proto_upb_file_layout,
  NULL,
  NULL,
  2,
  0,
