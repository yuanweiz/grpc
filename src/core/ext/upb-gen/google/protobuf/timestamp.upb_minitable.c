...
} google__protobuf__Timestamp_msg_init_Fields;

static const google__protobuf__Timestamp_msg_init_Fields google_protobuf_Timestamp__fields = {{
...
const upb_MiniTable google__protobuf__Timestamp_msg_init = {
  &google_protobuf_Timestamp__fields.fields[0],
...
static const upb_MiniTable *messages_layout_google_protobuf_timestamp_proto_upb_file_layout[1] = {
  &google__protobuf__Timestamp_msg_init,
};

const upb_MiniTableFile google_protobuf_timestamp_proto_upb_file_layout = {
  messages_layout_google_protobuf_timestamp_proto_upb_file_layout,
  NULL,
  NULL,
  1,
  0,
