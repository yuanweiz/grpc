...
static const upb_MiniTable *messages_layout_google_protobuf_duration_proto_upb_file_layout[1] = {
  &google__protobuf__Duration_msg_init,
};

const upb_MiniTableFile google_protobuf_duration_proto_upb_file_layout = {
  messages_layout_google_protobuf_duration_proto_upb_file_layout,
  NULL,
  NULL,
  1,
  0,
