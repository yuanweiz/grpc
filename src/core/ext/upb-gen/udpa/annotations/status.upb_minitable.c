...
const upb_MiniTableExtension* udpa_annotations_file_status_ext = &udpa_annotations_file_status_ext_obj;
  static const upb_MiniTable *messages_layout_udpa_annotations_status_proto_upb_file_layout[1] = {
  &udpa__annotations__StatusAnnotation_msg_init,
};


static const upb_MiniTableExtension *extensions_layout_udpa_annotations_status_proto_upb_file_layout[1] = {
...
const upb_MiniTableFile udpa_annotations_status_proto_upb_file_layout = {
  messages_layout_udpa_annotations_status_proto_upb_file_layout,
  NULL,
  extensions_layout_udpa_annotations_status_proto_upb_file_layout,
  1,
  0,
  1,
};
