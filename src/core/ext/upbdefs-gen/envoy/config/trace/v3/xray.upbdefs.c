...
static const char descriptor_envoy_config_trace_v3_xray_proto_upbdefinit[906] = {
    '\n', ' ', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
    'i', 'g', '/', 't', 'r', 'a', 'c', 'e', '/', 'v', '3', '/',
...
static _upb_DefPool_Init* deps_envoy_config_trace_v3_xray_proto_upbdefinit[8] = {
...
_upb_DefPool_Init envoy_config_trace_v3_xray_proto_upbdefinit = {
    deps_envoy_config_trace_v3_xray_proto_upbdefinit,
    &envoy_config_trace_v3_xray_proto_upb_file_layout,
    "envoy/config/trace/v3/xray.proto",
    UPB_STRINGVIEW_INIT(descriptor_envoy_config_trace_v3_xray_proto_upbdefinit,
                        sizeof(descriptor_envoy_config_trace_v3_xray_proto_upbdefinit)),
};
