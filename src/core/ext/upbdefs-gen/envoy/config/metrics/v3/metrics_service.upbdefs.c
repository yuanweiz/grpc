...
static const char descriptor_envoy_config_metrics_v3_metrics_service_proto_upbdefinit[1039] = {
    ...
    'U', '\n', '\031', 'r', 'e', 'p', 'o', 'r', 't', '_', 'c', 'o',
    'u', 'n', 't', 'e', 'r', 's', '_', 'a', 's', '_', 'd', 'e',
    'l', 't', 'a', 's', '\030', '\002', ' ', '\001', '(', '\013', '2', '\032',
    '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't',
    'o', 'b', 'u', 'f', '.', 'B', 'o', 'o', 'l', 'V', 'a', 'l',
    'u', 'e', 'R', '\026', 'r', 'e', 'p', 'o', 'r', 't', 'C', 'o',
    'u', 'n', 't', 'e', 'r', 's', 'A', 's', 'D', 'e', 'l', 't',
    'a', 's', '\022', '-', '\n', '\023', 'e', 'm', 'i', 't', '_', 't',
    'a', 'g', 's', '_', 'a', 's', '_', 'l', 'a', 'b', 'e', 'l',
    's', '\030', '\004', ' ', '\001', '(', '\010', 'R', '\020', 'e', 'm', 'i',
    't', 'T', 'a', 'g', 's', 'A', 's', 'L', 'a', 'b', 'e', 'l',
    's', '\022', 'd', '\n', '\023', 'h', 'i', 's', 't', 'o', 'g', 'r',
    'a', 'm', '_', 'e', 'm', 'i', 't', '_', 'm', 'o', 'd', 'e',
    '\030', '\005', ' ', '\001', '(', '\016', '2', '*', '.', 'e', 'n', 'v',
    'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'm', 'e',
    't', 'r', 'i', 'c', 's', '.', 'v', '3', '.', 'H', 'i', 's',
    't', 'o', 'g', 'r', 'a', 'm', 'E', 'm', 'i', 't', 'M', 'o',
    'd', 'e', 'B', '\010', '\372', 'B', '\005', '\202', '\001', '\002', '\020', '\001',
    'R', '\021', 'h', 'i', 's', 't', 'o', 'g', 'r', 'a', 'm', 'E',
    'm', 'i', 't', 'M', 'o', 'd', 'e', '\022', '&', '\n', '\n', 'b',
    'a', 't', 'c', 'h', '_', 's', 'i', 'z', 'e', '\030', '\006', ' ',
    '\001', '(', '\r', 'B', '\007', '\372', 'B', '\004', '*', '\002', '(', '\000',
    'R', '\t', 'b', 'a', 't', 'c', 'h', 'S', 'i', 'z', 'e', ':',
    '3', '\232', '\305', '\210', '\036', '.', '\n', ',', 'e', 'n', 'v', 'o',
    'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'm', 'e', 't',
    'r', 'i', 'c', 's', '.', 'v', '2', '.', 'M', 'e', 't', 'r',
    ...
    'n', 'f', 'i', 'g', '*', 'J', '\n', '\021', 'H', 'i', 's', 't',
    'o', 'g', 'r', 'a', 'm', 'E', 'm', 'i', 't', 'M', 'o', 'd',
    'e', '\022', '\031', '\n', '\025', 'S', 'U', 'M', 'M', 'A', 'R', 'Y',
    '_', 'A', 'N', 'D', '_', 'H', 'I', 'S', 'T', 'O', 'G', 'R',
    'A', 'M', '\020', '\000', '\022', '\013', '\n', '\007', 'S', 'U', 'M', 'M',
    'A', 'R', 'Y', '\020', '\001', '\022', '\r', '\n', '\t', 'H', 'I', 'S',
    'T', 'O', 'G', 'R', 'A', 'M', '\020', '\002', 'B', '\220', '\001', '\n',
    '%', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o',
    'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n',
    'f', 'i', 'g', '.', 'm', 'e', 't', 'r', 'i', 'c', 's', '.',
    'v', '3', 'B', '\023', 'M', 'e', 't', 'r', 'i', 'c', 's', 'S',
