...
static const char descriptor_envoy_config_metrics_v3_stats_proto_upbdefinit[2227] = {
    '\n', '#', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
    'i', 'g', '/', 'm', 'e', 't', 'r', 'i', 'c', 's', '/', 'v',
    '3', '/', 's', 't', 'a', 't', 's', '.', 'p', 'r', 'o', 't',
...
static _upb_DefPool_Init* deps_envoy_config_metrics_v3_stats_proto_upbdefinit[8] = {
...
_upb_DefPool_Init envoy_config_metrics_v3_stats_proto_upbdefinit = {
    deps_envoy_config_metrics_v3_stats_proto_upbdefinit,
    &envoy_config_metrics_v3_stats_proto_upb_file_layout,
    "envoy/config/metrics/v3/stats.proto",
    UPB_STRINGVIEW_INIT(descriptor_envoy_config_metrics_v3_stats_proto_upbdefinit,
                        sizeof(descriptor_envoy_config_metrics_v3_stats_proto_upbdefinit)),
};
