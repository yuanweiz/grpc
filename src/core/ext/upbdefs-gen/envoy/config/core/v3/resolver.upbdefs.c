...
static const char descriptor_envoy_config_core_v3_resolver_proto_upbdefinit[612] = {
    '\n', '#', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
    'i', 'g', '/', 'c', 'o', 'r', 'e', '/', 'v', '3', '/', 'r',
...
static _upb_DefPool_Init* deps_envoy_config_core_v3_resolver_proto_upbdefinit[4] = {
...
_upb_DefPool_Init envoy_config_core_v3_resolver_proto_upbdefinit = {
    deps_envoy_config_core_v3_resolver_proto_upbdefinit,
    &envoy_config_core_v3_resolver_proto_upb_file_layout,
    "envoy/config/core/v3/resolver.proto",
    UPB_STRINGVIEW_INIT(descriptor_envoy_config_core_v3_resolver_proto_upbdefinit,
                        sizeof(descriptor_envoy_config_core_v3_resolver_proto_upbdefinit)),
};
