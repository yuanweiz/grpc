...
static const char descriptor_envoy_config_core_v3_http_uri_proto_upbdefinit[531] = {
    '\n', '#', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
    'i', 'g', '/', 'c', 'o', 'r', 'e', '/', 'v', '3', '/', 'h',
    ...
    'R', '\003', 'u', 'r', 'i', '\022', '#', '\n', '\007', 'c', 'l', 'u',
    's', 't', 'e', 'r', '\030', '\002', ' ', '\001', '(', '\t', 'B', '\007',
    '\372', 'B', '\004', 'r', '\002', '\020', '\001', 'H', '\000', 'R', '\007', 'c',
    'l', 'u', 's', 't', 'e', 'r', '\022', 'G', '\n', '\007', 't', 'i',
    'm', 'e', 'o', 'u', 't', '\030', '\003', ' ', '\001', '(', '\013', '2',
    '\031', '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o',
    't', 'o', 'b', 'u', 'f', '.', 'D', 'u', 'r', 'a', 't', 'i',
    'o', 'n', 'B', '\022', '\372', 'B', '\017', '\252', '\001', '\014', '\010', '\001',
    '\032', '\006', '\010', '\200', '\200', '\200', '\200', '\020', '2', '\000', 'R', '\007',
    't', 'i', 'm', 'e', 'o', 'u', 't', ':', ' ', '\232', '\305', '\210',
    '\036', '\033', '\n', '\031', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'p',
    'i', '.', 'v', '2', '.', 'c', 'o', 'r', 'e', '.', 'H', 't',
    't', 'p', 'U', 'r', 'i', 'B', '\031', '\n', '\022', 'h', 't', 't',
    'p', '_', 'u', 'p', 's', 't', 'r', 'e', 'a', 'm', '_', 't',
    'y', 'p', 'e', '\022', '\003', '\370', 'B', '\001', 'B', '\200', '\001', '\n',
    '\"', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o',
    'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n',
    'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', 'B',
    '\014', 'H', 't', 't', 'p', 'U', 'r', 'i', 'P', 'r', 'o', 't',
...
static _upb_DefPool_Init* deps_envoy_config_core_v3_http_uri_proto_upbdefinit[5] = {
...
_upb_DefPool_Init envoy_config_core_v3_http_uri_proto_upbdefinit = {
    deps_envoy_config_core_v3_http_uri_proto_upbdefinit,
    &envoy_config_core_v3_http_uri_proto_upb_file_layout,
    "envoy/config/core/v3/http_uri.proto",
    UPB_STRINGVIEW_INIT(descriptor_envoy_config_core_v3_http_uri_proto_upbdefinit,
                        sizeof(descriptor_envoy_config_core_v3_http_uri_proto_upbdefinit)),
};
