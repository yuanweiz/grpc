...
static const char descriptor_envoy_config_common_matcher_v3_matcher_proto_upbdefinit[4229] = {
    ...
    'i', 'g', '/', 'c', 'o', 'm', 'm', 'o', 'n', '/', 'm', 'a',
    't', 'c', 'h', 'e', 'r', '/', 'v', '3', '/', 'm', 'a', 't',
    'c', 'h', 'e', 'r', '.', 'p', 'r', 'o', 't', 'o', '\022', '\036',
    'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g',
    '.', 'c', 'o', 'm', 'm', 'o', 'n', '.', 'm', 'a', 't', 'c',
    'h', 'e', 'r', '.', 'v', '3', '\032', '$', 'e', 'n', 'v', 'o',
    'y', '/', 'c', 'o', 'n', 'f', 'i', 'g', '/', 'c', 'o', 'r',
    'e', '/', 'v', '3', '/', 'e', 'x', 't', 'e', 'n', 's', 'i',
    ...
    'r', 'L', 'i', 's', 't', 'H', '\000', 'R', '\013', 'm', 'a', 't',
    'c', 'h', 'e', 'r', 'L', 'i', 's', 't', '\022', 'X', '\n', '\014',
    'm', 'a', 't', 'c', 'h', 'e', 'r', '_', 't', 'r', 'e', 'e',
    '\030', '\002', ' ', '\001', '(', '\013', '2', '3', '.', 'e', 'n', 'v',
    'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o',
    ...
    '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'm', 'm',
    'o', 'n', '.', 'm', 'a', 't', 'c', 'h', 'e', 'r', '.', 'v',
    '3', '.', 'M', 'a', 't', 'c', 'h', 'e', 'r', 'H', '\000', 'R',
    '\007', 'm', 'a', 't', 'c', 'h', 'e', 'r', '\022', 'D', '\n', '\006',
    'a', 'c', 't', 'i', 'o', 'n', '\030', '\002', ' ', '\001', '(', '\013',
    '2', '*', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n',
    'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.',
