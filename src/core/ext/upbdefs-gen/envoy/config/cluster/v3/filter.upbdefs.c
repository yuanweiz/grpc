...
static const char descriptor_envoy_config_cluster_v3_filter_proto_upbdefinit[591] = {
    ...
    'i', 'g', '/', 'c', 'l', 'u', 's', 't', 'e', 'r', '/', 'v',
    '3', '/', 'f', 'i', 'l', 't', 'e', 'r', '.', 'p', 'r', 'o',
    't', 'o', '\022', '\027', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o',
    'n', 'f', 'i', 'g', '.', 'c', 'l', 'u', 's', 't', 'e', 'r',
    '.', 'v', '3', '\032', '(', 'e', 'n', 'v', 'o', 'y', '/', 'c',
    'o', 'n', 'f', 'i', 'g', '/', 'c', 'o', 'r', 'e', '/', 'v',
    '3', '/', 'c', 'o', 'n', 'f', 'i', 'g', '_', 's', 'o', 'u',
    'r', 'c', 'e', '.', 'p', 'r', 'o', 't', 'o', '\032', '\031', 'g',
    ...
    'e', 'd', 'C', 'o', 'n', 'f', 'i', 'g', '\022', 'V', '\n', '\020',
    'c', 'o', 'n', 'f', 'i', 'g', '_', 'd', 'i', 's', 'c', 'o',
    'v', 'e', 'r', 'y', '\030', '\003', ' ', '\001', '(', '\013', '2', '+',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'E', 'x',
    't', 'e', 'n', 's', 'i', 'o', 'n', 'C', 'o', 'n', 'f', 'i',
    'g', 'S', 'o', 'u', 'r', 'c', 'e', 'R', '\017', 'c', 'o', 'n',
    'f', 'i', 'g', 'D', 'i', 's', 'c', 'o', 'v', 'e', 'r', 'y',
    ':', '\"', '\232', '\305', '\210', '\036', '\035', '\n', '\033', 'e', 'n', 'v',
    'o', 'y', '.', 'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'l',
    'u', 's', 't', 'e', 'r', '.', 'F', 'i', 'l', 't', 'e', 'r',
    'B', '\210', '\001', '\n', '%', 'i', 'o', '.', 'e', 'n', 'v', 'o',
