...
static const char descriptor_envoy_type_metadata_v3_metadata_proto_upbdefinit[1179] = {
    ...
    'd', 'a', 't', 'e', '.', 'p', 'r', 'o', 't', 'o', '\"', '\225',
    '\002', '\n', '\013', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'K',
    'e', 'y', '\022', '\031', '\n', '\003', 'k', 'e', 'y', '\030', '\001', ' ',
    '\001', '(', '\t', 'B', '\007', '\372', 'B', '\004', 'r', '\002', '\020', '\001',
    'R', '\003', 'k', 'e', 'y', '\022', 'M', '\n', '\004', 'p', 'a', 't',
    'h', '\030', '\002', ' ', '\003', '(', '\013', '2', '/', '.', 'e', 'n',
    'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'e', 't',
    'a', 'd', 'a', 't', 'a', '.', 'v', '3', '.', 'M', 'e', 't',
    'a', 'd', 'a', 't', 'a', 'K', 'e', 'y', '.', 'P', 'a', 't',
    'h', 'S', 'e', 'g', 'm', 'e', 'n', 't', 'B', '\010', '\372', 'B',
    '\005', '\222', '\001', '\002', '\010', '\001', 'R', '\004', 'p', 'a', 't', 'h',
    '\032', 'q', '\n', '\013', 'P', 'a', 't', 'h', 'S', 'e', 'g', 'm',
    'e', 'n', 't', '\022', '\033', '\n', '\003', 'k', 'e', 'y', '\030', '\001',
    ' ', '\001', '(', '\t', 'B', '\007', '\372', 'B', '\004', 'r', '\002', '\020',
    '\001', 'H', '\000', 'R', '\003', 'k', 'e', 'y', ':', '5', '\232', '\305',
    '\210', '\036', '0', '\n', '.', 'e', 'n', 'v', 'o', 'y', '.', 't',
    'y', 'p', 'e', '.', 'm', 'e', 't', 'a', 'd', 'a', 't', 'a',
    '.', 'v', '2', '.', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a',
    'K', 'e', 'y', '.', 'P', 'a', 't', 'h', 'S', 'e', 'g', 'm',
    'e', 'n', 't', 'B', '\016', '\n', '\007', 's', 'e', 'g', 'm', 'e',
    'n', 't', '\022', '\003', '\370', 'B', '\001', ':', ')', '\232', '\305', '\210',
    '\036', '$', '\n', '\"', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y',
    'p', 'e', '.', 'm', 'e', 't', 'a', 'd', 'a', 't', 'a', '.',
    'v', '2', '.', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'K',
    'e', 'y', '\"', '\322', '\004', '\n', '\014', 'M', 'e', 't', 'a', 'd',
    'a', 't', 'a', 'K', 'i', 'n', 'd', '\022', 'H', '\n', '\007', 'r',
    'e', 'q', 'u', 'e', 's', 't', '\030', '\001', ' ', '\001', '(', '\013',
    '2', ',', '.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p',
    'e', '.', 'm', 'e', 't', 'a', 'd', 'a', 't', 'a', '.', 'v',
    '3', '.', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'K', 'i',
    'n', 'd', '.', 'R', 'e', 'q', 'u', 'e', 's', 't', 'H', '\000',
    'R', '\007', 'r', 'e', 'q', 'u', 'e', 's', 't', '\022', 'B', '\n',
    '\005', 'r', 'o', 'u', 't', 'e', '\030', '\002', ' ', '\001', '(', '\013',
    '2', '*', '.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p',
    'e', '.', 'm', 'e', 't', 'a', 'd', 'a', 't', 'a', '.', 'v',
    '3', '.', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'K', 'i',
    'n', 'd', '.', 'R', 'o', 'u', 't', 'e', 'H', '\000', 'R', '\005',
    'r', 'o', 'u', 't', 'e', '\022', 'H', '\n', '\007', 'c', 'l', 'u',
    's', 't', 'e', 'r', '\030', '\003', ' ', '\001', '(', '\013', '2', ',',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.',
    'm', 'e', 't', 'a', 'd', 'a', 't', 'a', '.', 'v', '3', '.',
    'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'K', 'i', 'n', 'd',
    '.', 'C', 'l', 'u', 's', 't', 'e', 'r', 'H', '\000', 'R', '\007',
    'c', 'l', 'u', 's', 't', 'e', 'r', '\022', '?', '\n', '\004', 'h',
    'o', 's', 't', '\030', '\004', ' ', '\001', '(', '\013', '2', ')', '.',
    'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm',
    'e', 't', 'a', 'd', 'a', 't', 'a', '.', 'v', '3', '.', 'M',
    'e', 't', 'a', 'd', 'a', 't', 'a', 'K', 'i', 'n', 'd', '.',
    'H', 'o', 's', 't', 'H', '\000', 'R', '\004', 'h', 'o', 's', 't',
    '\032', '=', '\n', '\007', 'R', 'e', 'q', 'u', 'e', 's', 't', ':',
    '2', '\232', '\305', '\210', '\036', '-', '\n', '+', 'e', 'n', 'v', 'o',
    'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'e', 't', 'a', 'd',
    'a', 't', 'a', '.', 'v', '2', '.', 'M', 'e', 't', 'a', 'd',
    'a', 't', 'a', 'K', 'i', 'n', 'd', '.', 'R', 'e', 'q', 'u',
    'e', 's', 't', '\032', '9', '\n', '\005', 'R', 'o', 'u', 't', 'e',
    ':', '0', '\232', '\305', '\210', '\036', '+', '\n', ')', 'e', 'n', 'v',
    'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'e', 't', 'a',
    'd', 'a', 't', 'a', '.', 'v', '2', '.', 'M', 'e', 't', 'a',
    'd', 'a', 't', 'a', 'K', 'i', 'n', 'd', '.', 'R', 'o', 'u',
    't', 'e', '\032', '=', '\n', '\007', 'C', 'l', 'u', 's', 't', 'e',
    'r', ':', '2', '\232', '\305', '\210', '\036', '-', '\n', '+', 'e', 'n',
    'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'e', 't',
    'a', 'd', 'a', 't', 'a', '.', 'v', '2', '.', 'M', 'e', 't',
    ...
    'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'e', 't',
    'a', 'd', 'a', 't', 'a', '.', 'v', '2', '.', 'M', 'e', 't',
    'a', 'd', 'a', 't', 'a', 'K', 'i', 'n', 'd', '.', 'H', 'o',
    's', 't', ':', '*', '\232', '\305', '\210', '\036', '%', '\n', '#', 'e',
    'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'e',
    't', 'a', 'd', 'a', 't', 'a', '.', 'v', '2', '.', 'M', 'e',
    't', 'a', 'd', 'a', 't', 'a', 'K', 'i', 'n', 'd', 'B', '\013',
    '\n', '\004', 'k', 'i', 'n', 'd', '\022', '\003', '\370', 'B', '\001', 'B',
    '\211', '\001', '\n', '$', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y',
    'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.',
    't', 'y', 'p', 'e', '.', 'm', 'e', 't', 'a', 'd', 'a', 't',
    'a', '.', 'v', '3', 'B', '\r', 'M', 'e', 't', 'a', 'd', 'a',
    't', 'a', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', 'H', 'g',
    'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e', 'n',
    'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', '-',
    'c', 'o', 'n', 't', 'r', 'o', 'l', '-', 'p', 'l', 'a', 'n',
    'e', '/', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e',
    '/', 'm', 'e', 't', 'a', 'd', 'a', 't', 'a', '/', 'v', '3',
    ';', 'm', 'e', 't', 'a', 'd', 'a', 't', 'a', 'v', '3', '\272',
