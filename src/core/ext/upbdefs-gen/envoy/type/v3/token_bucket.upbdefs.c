...
static const char descriptor_envoy_type_v3_token_bucket_proto_upbdefinit[574] = {
    '\n', ' ', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e',
    '/', 'v', '3', '/', 't', 'o', 'k', 'e', 'n', '_', 'b', 'u',
...
static _upb_DefPool_Init* deps_envoy_type_v3_token_bucket_proto_upbdefinit[6] = {
...
_upb_DefPool_Init envoy_type_v3_token_bucket_proto_upbdefinit = {
    deps_envoy_type_v3_token_bucket_proto_upbdefinit,
    &envoy_type_v3_token_bucket_proto_upb_file_layout,
    "envoy/type/v3/token_bucket.proto",
    UPB_STRINGVIEW_INIT(descriptor_envoy_type_v3_token_bucket_proto_upbdefinit,
                        sizeof(descriptor_envoy_type_v3_token_bucket_proto_upbdefinit)),
};
