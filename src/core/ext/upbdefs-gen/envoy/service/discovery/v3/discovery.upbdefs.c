...
static const char descriptor_envoy_service_discovery_v3_discovery_proto_upbdefinit[4354] = {
    '\n', '*', 'e', 'n', 'v', 'o', 'y', '/', 's', 'e', 'r', 'v',
...
static _upb_DefPool_Init* deps_envoy_service_discovery_v3_discovery_proto_upbdefinit[8] = {
...
_upb_DefPool_Init envoy_service_discovery_v3_discovery_proto_upbdefinit = {
    deps_envoy_service_discovery_v3_discovery_proto_upbdefinit,
    &envoy_service_discovery_v3_discovery_proto_upb_file_layout,
    "envoy/service/discovery/v3/discovery.proto",
    UPB_STRINGVIEW_INIT(descriptor_envoy_service_discovery_v3_discovery_proto_upbdefinit,
                        sizeof(descriptor_envoy_service_discovery_v3_discovery_proto_upbdefinit)),
};
