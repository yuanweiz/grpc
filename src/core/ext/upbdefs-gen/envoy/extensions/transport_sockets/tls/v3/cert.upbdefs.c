...
static const char descriptor_envoy_extensions_transport_sockets_tls_v3_cert_proto_upbdefinit[437] = {
    '\n', '4', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
...
static _upb_DefPool_Init* deps_envoy_extensions_transport_sockets_tls_v3_cert_proto_upbdefinit[4] = {
...
_upb_DefPool_Init envoy_extensions_transport_sockets_tls_v3_cert_proto_upbdefinit = {
    deps_envoy_extensions_transport_sockets_tls_v3_cert_proto_upbdefinit,
    &envoy_extensions_transport_sockets_tls_v3_cert_proto_upb_file_layout,
    "envoy/extensions/transport_sockets/tls/v3/cert.proto",
    UPB_STRINGVIEW_INIT(descriptor_envoy_extensions_transport_sockets_tls_v3_cert_proto_upbdefinit,
                        sizeof(descriptor_envoy_extensions_transport_sockets_tls_v3_cert_proto_upbdefinit)),
};
