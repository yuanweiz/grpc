...
static const char descriptor_envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upbdefinit[487] = {
    '\n', '=', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
    'n', 's', 'i', 'o', 'n', 's', '/', 'h', 't', 't', 'p', '/',
...
static _upb_DefPool_Init* deps_envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upbdefinit[4] = {
...
_upb_DefPool_Init envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upbdefinit = {
    deps_envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upbdefinit,
    &envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upb_file_layout,
    "envoy/extensions/http/stateful_session/cookie/v3/cookie.proto",
    UPB_STRINGVIEW_INIT(descriptor_envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upbdefinit,
                        sizeof(descriptor_envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_upbdefinit)),
};
