...
static const char descriptor_src_proto_grpc_channelz_v2_property_list_proto_upbdefinit[1170] = {
    '\n', '.', 's', 'r', 'c', '/', 'p', 'r', 'o', 't', 'o', '/',
...
static _upb_DefPool_Init* deps_src_proto_grpc_channelz_v2_property_list_proto_upbdefinit[5] = {
...
_upb_DefPool_Init src_proto_grpc_channelz_v2_property_list_proto_upbdefinit = {
    deps_src_proto_grpc_channelz_v2_property_list_proto_upbdefinit,
    &src_proto_grpc_channelz_v2_property_list_proto_upb_file_layout,
    "src/proto/grpc/channelz/v2/property_list.proto",
    UPB_STRINGVIEW_INIT(descriptor_src_proto_grpc_channelz_v2_property_list_proto_upbdefinit,
                        sizeof(descriptor_src_proto_grpc_channelz_v2_property_list_proto_upbdefinit)),
};
